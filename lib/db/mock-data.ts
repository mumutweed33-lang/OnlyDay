...
export const MOCK_MOMENTOS: Momento[] = [
  {
    ...
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=luna&backgroundColor=7C3AED',
    userUsername: '@lunaestela',
    userBio: 'Criadora premium focada em lifestyle e proximidade real com a comunidade.',
    isVerified: true,
    isCreator: true,
  ...
  },
  {
    ...
    isVerified: true,
    isCreator: true,
    media: 'https://picsum.photos/seed/luna-mom2/400/700',
    mediaType: 'image',
    isLocked: false,
    viewCount: 1451,
    duration: 5000,
  ...
  },
  {
    ...
    isVerified: true,
    isCreator: true,
    media: 'https://picsum.photos/seed/luna-mom3/400/700',
    mediaType: 'image',
    isLocked: false,
    viewCount: 1304,
    duration: 5000,
  ...
  },
  {
    ...
    isVerified: true,
    isCreator: true,
    media: 'https://picsum.photos/seed/luna-mom4/400/700',
    mediaType: 'image',
    isLocked: true,
    price: 24.9,
    dailyFreeCount: 3,
  ...
  },
  {
    ...
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=rafael&backgroundColor=6D28D9',
    userUsername: '@rafaelouro',
    userBio: 'Musica, processo criativo e conversas exclusivas com quem apoia primeiro.',
    isVerified: true,
    isCreator: true,
  ...
  },
  {
    ...
    userAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sofia&backgroundColor=5B21B6',
    userUsername: '@sofiadark',
    userBio: 'Arte, bastidores e drops premium para uma comunidade mais intima.',
    isVerified: true,
    isCreator: true,
